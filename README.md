...
![Окно инспектора генератора трубы](Images/PipeGeneratorInspector.png)
...
![Контекстное меню генератора трубы](Images/GeneratePipeMenu.png)
...
![Различие количество граней](Images/FacesCount.png)
...
![Различие коэффициентов отступа соединения трубы](Images/ConnectionOffsetCoef.png)
...
![Различие количество поясов соединения](Images/ConnectionBeltsCount.png)
